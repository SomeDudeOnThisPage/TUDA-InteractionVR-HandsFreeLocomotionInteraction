...
public class OVRCameraRig : MonoBehaviour
{
    ...
    protected readonly string trackingSpaceName = "ovr-camera";
    protected readonly string trackerAnchorName = "tracker-anchor";
    protected readonly string leftEyeAnchorName = "left-eye-anchor";
    protected readonly string centerEyeAnchorName = "center-eye-anchor";
    protected readonly string rightEyeAnchorName = "right-eye-anchor";
    protected readonly string leftHandAnchorName = "left-hand-anchor";
    protected readonly string rightHandAnchorName = "right-hand-anchor";
    protected readonly string leftControllerAnchorName = "left-controller-anchor";
    protected readonly string rightControllerAnchorName = "right-controller-anchor";
